...
LINUX_REF_BIN_HOST="$(cd "$(dirname "$0")/.." && pwd)/../../05-Executables/reference/solvitaire-trace-reference-linux-amd64-20260527-5f4a907"
LINUX_REF_BIN_CONTAINER="/05-Executables/reference/solvitaire-trace-reference-linux-amd64-20260527-5f4a907"
